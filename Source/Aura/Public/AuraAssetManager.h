 ...
 */
//todo:urgent, set defaultpawndata in game.ini
UCLASS(Config = Game)
...
public:
	...
	const UAuraGameData& GetGameData();
	const UAuraPawnData* GetDefaultPawnData() const;
...
protected:
	...
	UPROPERTY(Config)
	TSoftObjectPtr<UAuraGameData> LyraGameDataPath;
	...
	UPROPERTY(Config)
	TSoftObjectPtr<UAuraPawnData> DefaultPawnData;
...
private:
	...
	TArray<FAuraAssetManagerStartupJob> StartupJobs;
