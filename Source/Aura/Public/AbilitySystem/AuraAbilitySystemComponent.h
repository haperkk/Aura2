...
AURA_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Gameplay_AbilityInputBlocked);
...
class AURA_API UAuraAbilitySystemComponent : public UAbilitySystemComponent
{
	...
	bool IsActivationGroupBlocked(EAuraAbilityActivationGroup Group) const;
	void AddAbilityToActivationGroup(EAuraAbilityActivationGroup Group, UAuraGameplayAbility* LyraAbility);
	void RemoveAbilityFromActivationGroup(EAuraAbilityActivationGroup Group, UAuraGameplayAbility* LyraAbility);
	void CancelActivationGroupAbilities(EAuraAbilityActivationGroup Group, UAuraGameplayAbility* IgnoreLyraAbility, bool bReplicateCancelAbility);
...
protected:
	...
	//todo: figure out what's unreliable
...
protected:
	...
	int32 ActivationGroupCounts[(uint8)EAuraAbilityActivationGroup::MAX];
