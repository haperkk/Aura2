...
UAuraExperienceDefinition::UAuraExperienceDefinition()
{
}

//todo: what's this
#if WITH_EDITOR
EDataValidationResult UAuraExperienceDefinition::IsDataValid(TArray<FText>& ValidationErrors)
{
...
void UAuraExperienceDefinition::UpdateAssetBundleData()
{
